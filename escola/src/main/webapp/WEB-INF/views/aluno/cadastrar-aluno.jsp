	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title text-center">CADASTRO DE ALUNO</h3>
			</div>
			...
			<div class="panel-body">
				...
				<form action="#" class="form-horizontal">
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="indicador1" class="col-sm-2 control-label">Indicador 1</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="indicador1">
							</div>
						</div>
						
						<div class="form-group">
							<label for="indicador2" class="col-sm-2 control-label">Indicador 2</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="indicador2">
							</div>
						</div>						
					</fieldset>
